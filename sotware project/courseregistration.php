...
<div id="sitename">
		...
		<section id="body" class="width clear">
			...
			<option value="SAS.php">SAS</option>
			<option value="SMEC.php">SMEC</option>
			<option value="SITE.php">SITE</option>
			<option value="SCOPE.php">SCOPE</option>
			<option value="SSL.php">SSL</option>
			<option value="SENSE.php">SENSE</option>
			<option value="SELECT.php">SELECT</option>
			</select>
